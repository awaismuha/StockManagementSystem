    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GINItemId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GINId = table.Column<int>(type: "int", nullable: false),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GINItems", x => x.GINItemId);
                    table.ForeignKey(
                        name: "FK_GINItems_GINs_GINId",
                        column: x => x.GINId,
                        principalTable: "GINs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GINItems_GINId",
                table: "GINItems",
                column: "GINId");

            migrationBuilder.CreateIndex(
                name: "IX_GINItems_ProductId",
                table: "GINItems",
                column: "ProductId");
